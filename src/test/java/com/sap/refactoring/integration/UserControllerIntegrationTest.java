...
public class UserControllerIntegrationTest {
    ...
    void testAddUser_Success() {
        ...
        ResponseEntity<UserDto> response = restTemplate.postForEntity(baseUrl + "/add", newUser, UserDto.class);
    ...
    void testAddUser_MissingEmail_Failure() {
        ...
        ResponseEntity<String> response = restTemplate.postForEntity(baseUrl + "/add", newUser, String.class);
    ...
    void testUpdateUser_Success() {
        ...
        UserDto createdUser = restTemplate.postForEntity(baseUrl + "/add", newUser, UserDto.class).getBody();

        assertThat(createdUser).isNotNull();

        UserDto updatedUser = new UserDto(createdUser.getId(), "Jane Smith", "jane.smith@example.com", createdUser.getRoles());
        ResponseEntity<UserDto> response = restTemplate.exchange(
                baseUrl + "/update/" + createdUser.getId(),
                HttpMethod.PUT,
    ...
    void testDeleteUser_Success() {
        ...
        ResponseEntity<Void> response = restTemplate.exchange(
                baseUrl + "/delete/" + createdUser.getId(),
                HttpMethod.DELETE,
                null,
                Void.class
        );
    ...
    void testGetAllUsers() {
        ...
        restTemplate.postForEntity(baseUrl + "/add", user1, UserDto.class);
        restTemplate.postForEntity(baseUrl + "/add", user2, UserDto.class);

        ResponseEntity<UserDto[]> response = restTemplate.getForEntity(baseUrl + "/find", UserDto[].class);
    ...
    void testFindUserByName_Success() {
        ...
        restTemplate.postForEntity(baseUrl + "/add", newUser, UserDto.class);
